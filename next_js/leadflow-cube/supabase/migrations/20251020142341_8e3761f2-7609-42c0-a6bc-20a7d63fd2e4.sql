...
-- Inserir metas de teste para os vendedores (usando ON CONFLICT para evitar duplicação)
INSERT INTO public.goals (id, company_id, seller_id, periodo, valor_meta, valor_atingido, created_at, updated_at)
VALUES 
  ('44444444-4444-4444-4444-444444444441'::uuid, '11111111-1111-1111-1111-111111111111'::uuid, '22222222-2222-2222-2222-222222222221'::uuid, '2025-10', 150000.00, 95000.00, now(), now()),
  ('44444444-4444-4444-4444-444444444442'::uuid, '11111111-1111-1111-1111-111111111111'::uuid, '22222222-2222-2222-2222-222222222222'::uuid, '2025-10', 120000.00, 66000.00, now(), now()),
  ('44444444-4444-4444-4444-444444444443'::uuid, '11111111-1111-1111-1111-111111111111'::uuid, '22222222-2222-2222-2222-222222222223'::uuid, '2025-10', 180000.00, 103000.00, now(), now())
ON CONFLICT (id) DO NOTHING;
