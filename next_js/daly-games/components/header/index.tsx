...
export function Header() {
  return (
    <header className="w-full bg-slate-100 text-black px-2">
      <div className="max-w-7xl mx-auto py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex flex-row items-center justify-center gap-4">
            <Link href={'/games'} className="text-lg font-medium hover:text-orange-500 transition-colors flex flex-row items-center gap-2">              
              <p>Games</p>
            </Link>
